 ...
 * @author       : 
 * @Description  : 공통적으로 필요한 데이터 변환기능 및 문자열 조작기능
 * @History      : 
 */
public class FTCStringUtil {
	...
	public static String subString(String str, int offset, int leng) {
		...
		return str.substring(offset, leng);
	}
	...
	public static String fitString(String str, int size) {
		return fitString(str, size, FTCStringUtil.LEFT);
	}
	 ...
	 *
	 * @param     str         원 문자열
	 * @return    retr        camelCase로 변형된 문자열
	 *
	 */
	 ...
	 *
	 * @param     phone         원 문자열
	 * @return    retr        번호별 구분된 문자배열
	 *
	 */
    public static String[] getPhoneNo(String phone) {
