...
<%-- 			</c:if>			 --%>
	...
	<!----- /Grid ----->
		<display:table class="simple" name="${list}" size="${totalCnt}" id="grid" partialList="true"  decorator="fatca.common.decorator.FTCTableFormat"
			...
			<display:column property="custNm" title="한글" groupTitle="고객명" style="text-align:left"/>
			<display:column property="fatcaEngFsn" title="영문성" groupTitle="고객명" style="text-align:center"/>
			<display:column property="fatcaEnm" title="영문명" groupTitle="고객명" style="text-align:center"/>
			<display:column property="fatcaPrsnlEngAddr" title="주소" maxLength="8" style="text-align:left"/>
			<display:column property="perTxpayrNo" title="TIN" style="text-align:center"/>
			<display:column property="bird" title="생년월일" style="text-align:center"/>
			<display:column property="acno" title="계좌번호" style="text-align:center"/>
			<!-- display:column property="giinName" title="금융기관" maxLength="2" style="text-align:center"/ -->
			<!-- display:column property="giinNo" title="식별번호" maxLength="2" style="text-align:center"/ -->
